def get_document_rank(goldset, documents):
...
def calculate_mrr(goldsets, results):
    ...
    return 1/len(results) * sum([(get_document_rank(g, r['documents']['res'])) for g, r in zip(goldsets, results)])
